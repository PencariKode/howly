    ...
    return (
        <MainContainer>
            <div className="w-full max-w-2xl mx-auto pt-16 sm:pt-24 pb-8 flex flex-col items-center gap-6">
                ...
                <div
                    className="glass-card w-full max-w-lg bg-glass/85 border border-glass-border/60 shadow-[0_8px_32px_-8px] shadow-black/30"
                >
                    <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                        ...
                        Silakan buat issue baru dengan label <code className="bg-white/[0.06] px-1.5 py-0.5 rounded text-rose-300 text-xs font-mono">help</code> untuk mendapatkan bantuan.
                    </p>
                    <a
