...
export default function Header() {
    ...
    return (
        <header className={`flex items-center justify-center px-4 min-h-14 max-h-18 minMaxWidth text-hl-text ${isScreenScrolled ? 'bg-hl-primary h-14' : 'h-18 bg-transparent'} sticky top-0 !z-50 transition-all duration-500 ${isHeaderOpen ? 'opacity-100 translate-0' : 'opacity-0 -translate-y-16'}`}>
