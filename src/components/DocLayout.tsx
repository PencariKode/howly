        ...
        <MainContainer>
            <article className="w-full max-w-3xl mx-auto pt-8 sm:pt-16 pb-8 flex flex-col gap-8 sm:gap-10">
                ...
                <div className="flex flex-col gap-6 text-[.82rem] sm:text-sm text-zinc-300 leading-relaxed
                    ...
                    [&_code]:bg-[#FFFFFF0F] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-[.78rem] [&_code]:text-rose-300 [&_code]:font-mono
                    [&_pre]:bg-[#FFFFFF0A] [&_pre]:rounded-lg [&_pre]:p-4 [&_pre]:overflow-x-auto [&_pre]:text-[.78rem] [&_pre]:font-mono [&_pre]:text-zinc-300 [&_pre]:border [&_pre]:border-[#FFFFFF0F]
                    [&_table]:w-full [&_table]:text-left [&_table]:text-[.78rem]
                    [&_th]:text-zinc-200 [&_th]:font-semibold [&_th]:px-3 [&_th]:py-2 [&_th]:border-b [&_th]:border-[#FFFFFF1A]
                    [&_td]:px-3 [&_td]:py-2 [&_td]:border-b [&_td]:border-[#FFFFFF0D] [&_td]:text-zinc-400
                ">
                    { children }
                </div>
            </article>
