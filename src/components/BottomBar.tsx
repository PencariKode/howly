...
export default function BottomBar() {
    ...
    return (
        <nav
            ...
            className={`flex items-end justify-around gap-2 min-h-17 ${isScreenScrolled ? 'p-4' : 'pb-2'} px-2 text-hl-text bg-hl-primary z-50 !fixed minMaxWidth bottom-0 opacity-100 translate-y-0 transition-all duration-400`}>
