...
export default function Footer() {
    return (
        <footer className="minMaxWidth">
            <div className="bg-hl-secondary text-hl-text py-4 text-center pb-22 px-5 h-fit">
                <p className="text-xs pb-3">
                    Made with <i className="fa-solid fa-heart text-red-500"></i> by <a href="https://github.com/PencariKode">PencariKode</a>
                </p>
                <div style={{borderTopWidth: '0.5px'}} className=" border-t-neutral-50/20 items-start flex flex-wrap justify-between gap-5 font-extralight  minMaxWidth pt-3 text-xs px-2 text-hl-text/70">
